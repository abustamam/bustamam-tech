            ...
            {[
              {
                ...
                description:
                  "Built a complete MVP platform for an early-stage startup, including user authentication, payment processing, and real-time features. Launched in 3 months.",
              ...
              },
              {
                ...
                description:
                  "Developed a scalable e-commerce platform with inventory management, order processing, and analytics dashboard. Handles 10K+ daily transactions.",
              ...
              },
              {
                ...
                description:
                  "Created a comprehensive analytics platform with real-time dashboards, custom reporting, and data visualization. Serves 500+ active users.",
              ...
              },
              {
                ...
                description:
                  "Designed and developed a mobile-first progressive web app with offline capabilities and push notifications. Achieved 90+ Lighthouse score.",
          ...
          <Card className="border-2 bg-gradient-to-br from-primary/5 to-primary/10 animate-slide-up">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg">
                We're constantly working with new startups. Check back soon to
                see more of our work, or reach out to discuss your project.
              </CardDescription>
            </CardHeader>
